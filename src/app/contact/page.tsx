            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <form className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button
                    type="submit"
                    className="flex-1 bg-teal-500 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-teal-600 transition-colors focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
                  >
                    GET QUOTE NOW
                  </button>
                  <a
